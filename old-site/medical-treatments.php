...
<head>
    ...
    <!-- Page Title -->
    <title>Medische behandeling - Skin & Vision Clinic: Ooglid- en injectable-oogartsenkliniek in Amsterdam</title>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Medische behandeling</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index">home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">behandeling</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-item wow fadeInUp" data-wow-delay="0.8s">
                        <div class="case-study-image">
                            <a href="entropion-correction" data-cursor-text="Bekijk">
                                <figure class="image-anime">
                                    <img src="images/entropion-correction.jpg" alt="Entropioncorrectie Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="entropion-correction">Entropioncorrectie</a></h2>
                            </div>
                            <div class="case-study-btn">
                                <a href="entropion-correction" class="readmore-btn">Lees meer</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-item wow fadeInUp" data-wow-delay="1s">
                        <div class="case-study-image">
                            <a href="ectropion-correction" data-cursor-text="Bekijk">
                                <figure class="image-anime">
                                    <img src="images/ectropion-correction.jpg" alt="Ectropioncorrectie Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="ectropion-correction">Ectropioncorrectie</a></h2>
                            </div>
                            <div class="case-study-btn">
                                <a href="ectropion-correction" class="readmore-btn">Lees meer</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="case-study-item wow fadeInUp">
                        <div class="case-study-image">
                            <a href="botox-treatments" data-cursor-text="Bekijk">
                                <figure class="image-anime">
                                    <img src="images/botox-image-3.jpg" alt="Botuline Toxine Behandelingen Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="botox-treatments">Botuline Toxine (Botox)</a></h2>
                            </div>
                            <div class="case-study-btn">
