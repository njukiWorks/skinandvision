...
<head>
    ...
    <!-- Page Title -->
    <title>Treatments - Skin & Vision Clinic: Ooglid- en injectable-oogartsenkliniek in Amsterdam</title>
    <!-- Favicon Icon -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Behandelingen</h1>
                ...
                <div class="col-lg-6">
                    <div class="our-commitment-content">
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Zorg die verder gaat dan het fysieke</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">
                                Uw uitstraling, onze expertise. Bij Skin & Vision Clinic helpen we u uw natuurlijke schoonheid op een veilige en verantwoorde manier te versterken met medische en cosmetische behandelingen.
                            </p>
                        </div>
                        <div class="commitment-body wow fadeInUp" data-wow-delay="0.4s">
                            <div class="commitment-body-item">
                                <a href="cosmetic-treatments" style="display: flex;color: var(--text-color);">
                                    <div class="icon-box">
                                        <img src="images/icon-service-2.svg" alt="">
                                    </div>
                                    <div class="commitment-body-content">
                                        <h3>Cosmetische Behandelingen</h3>
                                        <p>Medische of esthetische behandelingen die gericht zijn op het verbeteren van uw uiterlijk en uitstraling</p>
                                    </div>
                                </a>
                            </div>
                            <div class="commitment-body-item">
                                <a href="medical-treatments" style="display: flex;color: var(--text-color);">
                                    <div class="icon-box">
                                        <img src="images/icon-commitment-body-2.svg" alt="">
                                    </div>
                                    <div class="commitment-body-content">
                                        <h3>Medische Behandelingen</h3>
                                        <p>Onze therapieën voor pijnverlichting helpen u om ongemak effectief te verminderen en uw welzijn te verbeteren.</p>
                                    </div>
                                </a>
                            </div>
                        </div>
