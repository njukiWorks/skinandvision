...
<head>
    ...
    <!-- Page Title -->
    <title>Cosmetische behandeling - Skin & Vision Clinic: Ooglid- en injectable-oogartsenkliniek in Amsterdam</title>
    ...
    <meta property="og:url" content="https://skinandvision.nl/cosmetic-treatments">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Cosmetische behandelings</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index">home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">behandelings</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="case-study-item wow fadeInUp">
                        <div class="case-study-image">
                            <a href="botox-treatments" data-cursor-text="Bekijk">
                                <figure class="image-anime">
                                    <img src="images/botox-image-3.jpg" alt="Rimpelbehandeling met spierontspannende injecties Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="botox-treatments">Rimpelbehandeling met spierontspannende injecties</a></h2>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="case-study-image">
                            <a href="upper-eyelid-correction" data-cursor-text="Bekijk">
                                <figure class="image-anime">
                                    <img src="images/upper-eyelid-correction.jpg" alt="Bovenooglidcorrectie Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="upper-eyelid-correction">Bovenooglidcorrectie</a></h2>
                            </div>
                            <div class="case-study-btn">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-item wow fadeInUp" data-wow-delay="0.4s">
                        <div class="case-study-image">
                            <a href="lower-eyelid-correction" data-cursor-text="Bekijk">
                                <figure class="image-anime">
                                    <img src="images/lower-eyelid-correction.jpg" alt="Onderooglidcorrectie Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="lower-eyelid-correction">Onderooglidcorrectie</a></h2>
                            </div>
                            <div class="case-study-btn">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-item wow fadeInUp" data-wow-delay="0.6s">
                        <div class="case-study-image">
                            <a href="ptosis-surgery" data-cursor-text="Bekijk">
                                <figure class="image-anime">
                                    <img src="images/ptosis-surgery.jpg" alt="Ptosisoperatie Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="ptosis-surgery">Ptosisoperatie</a></h2>
                            </div>
                            <div class="case-study-btn">
