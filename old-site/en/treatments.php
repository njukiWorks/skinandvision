...
<head>
    ...
    <!-- Page Title -->
    <title>Treatments - Skin & Vision Clinic: Eyelid and Injectable Eye Specialists Clinic in Amsterdam</title>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Treatments</h1>
                ...
                <div class="col-lg-6">
                    <div class="our-commitment-image">
                        <figure class="image-anime reveal">
                            <img src="images/cosmetic-treatment.jpg" alt="Skin & Vision Clinic Treatments">
                        </figure>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="our-commitment-content">
                        <div class="section-title">
                            <h3 class="wow fadeInUp">Our Treatments</h3>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Healing you beyond the physical</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Your look, our expertise. At Skin & Vision Clinic, we enhance your natural appearance with careful medical and cosmetic treatments.</p>
                        </div>
                            ...
                            <div class="commitment-body-item">
                                <a href="cosmetic-treatments" style="display: flex;color: var(--text-color);">
                                    ...
                                    <div class="commitment-body-content">
                                        ...
                                        <p>non-essential medical or aesthetic procedure aimed at improving appearance</p>
                                    </div>
                                </a>
                            </div>
                            <div class="commitment-body-item">
