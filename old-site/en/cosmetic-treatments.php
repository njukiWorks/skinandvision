...
<head>
    ...
    <!-- Page Title -->
    <title>Cosmetic treatment - Skin & Vision Clinic: Eyelid and Injectable Eye Specialists Clinic in Amsterdam</title>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Cosmetic Treatments</h1>
            ...
            <div class="row">
                        ...
                        <div class="case-study-image">
                            <a href="botox-treatments" data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="images/botox-image-3.jpg" alt="Wrinkle treatment with muscle-relaxing injections Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="botox-treatments">Wrinkle treatment with muscle-relaxing injections</a></h2>
                            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="case-study-image">
                            <a href="upper-eyelid-correction" data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="images/upper-eyelid-correction.jpg" alt="Upper eyelid correction Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="upper-eyelid-correction">Upper eyelid correction</a></h2>
                            </div>
                            <div class="case-study-btn">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="case-study-item wow fadeInUp" data-wow-delay="0.4s">
                        <div class="case-study-image">
                            <a href="lower-eyelid-correction" data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="images/lower-eyelid-correction.jpg" alt="Lower eyelid correction Skin & Vision Clinic">
                                </figure>
                            </a>
                        </div>
                        <div class="case-study-item-body">
                            <div class="case-study-content">
                                <h2><a href="lower-eyelid-correction">Lower eyelid correction</a></h2>
                            </div>
                            <div class="case-study-btn">
