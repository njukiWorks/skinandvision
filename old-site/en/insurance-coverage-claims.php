...
<head>
    ...
    <!-- Page Title -->
    <title>Insurance Coverage & Claims - Skin & Vision Clinic: Eyelid and Injectable Eye Specialists Clinic in Amsterdam</title>
    ...
    <meta property="og:url" content="https://skinandvision.nl/insurance-coverage-claims.php">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-3" data-cursor="-opaque">Insurance Coverage & Claims</h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index">home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">insurance coverage & claims</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
                ...
                <div class="col-lg-12">
                    <div class="our-commitment-content">
                        <div class="section-title">
                            <h3 class="wow fadeInUp">Submitting a Claim to Your Health Insurer</h3>
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Medical care at Skin &amp; Vision Clinics – reimbursed even without a contract</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Your medical treatment at Skin &amp; Vision Clinics is reimbursed by all health
                                insurers if there is a medical indication and you have a referral from your general
                                practitioner or medical specialist. This means you do not need to worry: even
                                without a direct contract, you can receive insured medical care with us.</p>
                        </div>
                    </div>
                </div>
            </div>
