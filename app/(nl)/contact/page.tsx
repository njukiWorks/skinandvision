...
export const metadata = buildMetadata({
  ...
  description:
    "Neem contact op met Skin & Vision Clinic in Amsterdam. Pietersbergweg 291, 1105 BM Amsterdam. Bel +31 6 4609 6641 of maak direct een afspraak.",
  path: "/contact",
});
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-[#f2ede6] h-[434px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-24 lg:py-32">
          <SectionLabel className="mb-4 text-[#ff8835]">Neem contact op</SectionLabel>
          <h1
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <ScrollReveal>
            <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-[0_4px_40px_rgba(0,0,0,0.07)]">
              <SectionLabel className="mb-6">Stuur een bericht</SectionLabel>
              <ContactForm />
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={0.1} className="flex flex-col gap-8">
            <div>
              <SectionLabel className="mb-8">Kliniek informatie</SectionLabel>
              <ul className="space-y-6">
                <li>
                  <p className="text-[#ff8835] text-xs uppercase tracking-widest font-semibold mb-1">Adres</p>
                  <p className="text-[#2a2420] text-sm">Pietersbergweg 291<br />1105 BM Amsterdam</p>
                </li>
                <li>
                  <p className="text-[#ff8835] text-xs uppercase tracking-widest font-semibold mb-1">Telefoon</p>
                  <a href="tel:+31646096641" className="text-[#2a2420] text-sm hover:text-[#ff8835] transition-colors">
                    +31 6 4609 6641
                  </a>
                </li>
                <li>
                  <p className="text-[#ff8835] text-xs uppercase tracking-widest font-semibold mb-1">E-mail</p>
                ...
                <li>
                  <p className="text-[#ff8835] text-xs uppercase tracking-widest font-semibold mb-1">Openingstijden</p>
                  <p className="text-[#2a2420] text-sm">Maandag – Vrijdag: 09:00 – 17:00</p>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#fff0e6] rounded-2xl p-8">
              ...
              <p className="text-[#b0a090] text-sm leading-relaxed mb-6">
                Gebruik ons online boekingssysteem om direct een consultatie te plannen op een
                tijdstip dat u uitkomt.
              </p>
              <a
                href={BOOKING_URL}
                target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 mt-16">
          <div className="rounded-2xl overflow-hidden h-72 lg:h-96">
            <iframe
              ...
              title="Skin & Vision Clinic locatie"
            />
          </div>
        </div>
      </section>
