...
export const tarieven: PriceCategory[] = [
  {
    ...
    procedures: [
      ...
      { name: "Botox 1 zone (fronsrimpel, voorhoofd of kraaienpootjes)", price: 160 },
      { name: "Botox 2 zones (fronsrimpel, voorhoofd of kraaienpootjes)", price: 300 },
      { name: "Botox 3 zones (fronsrimpel, voorhoofd en kraaienpootjes)", price: 400 },
      { name: "Epiphora (overmatige traanproductie)", price: 130 },
      { name: "Botox wenkbrauw lifting", price: 160 },
  ...
  },
  {
    ...
    procedures: [
      { name: "Bovenooglidcorrectie (Blepharoplatiek, beide ogen)", price: 900 },
